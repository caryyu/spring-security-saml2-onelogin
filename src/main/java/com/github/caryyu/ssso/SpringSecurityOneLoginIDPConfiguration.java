...
public class SpringSecurityOneLoginIDPConfiguration extends WebSecurityConfigurerAdapter {
 ...
 // SAML Authentication Provider responsible for validating of received SAML
    ...
    public SingleLogoutProfile logoutprofile() {
        return new OneLoginSingleLogoutProfileImpl();
    }
 ...
 // Setup TLS Socket Factory
    ...
    public SavedRequestAwareAuthenticationSuccessHandler successRedirectHandler() {
        ...
        successRedirectHandler.setDefaultTargetUrl(successURL);
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        ...
        http
            ...
            .anyRequest().authenticated().and().formLogin().loginPage(idpURL);
    }
